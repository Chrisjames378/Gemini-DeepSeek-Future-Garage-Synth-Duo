...
import { Sliders, Waves, Compass, Disc3, Sparkles } from 'lucide-react';
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-200">
              Master Acoustics & FX Engine
            </h3>
            <span className="text-[10px] font-mono text-teal-400">Atmospheric Space & Shuffles</span>
          </div>
        </div>
