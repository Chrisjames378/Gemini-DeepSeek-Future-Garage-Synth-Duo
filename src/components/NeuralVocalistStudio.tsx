...
interface NeuralVocalistStudioProps {
  onSingAnthem: () => void;
  onTestVoice: (model: 'Gemini' | 'DeepSeek') => void;
}
    ...
    <div className="bg-slate-900/90 border border-slate-800/80 rounded-2xl p-5 shadow-xl flex flex-col">
      <div className="flex items-center justify-between mb-3.5 pb-2.5 border-b border-slate-800">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-xs font-bold uppercase tracking-wider text-slate-200">
              AI Duo Neural Vocalist Studio
            </h2>
            <span className="text-[10px] font-mono text-rose-400">Atmospheric Vocal Chop Formants</span>
          </div>
        </div>
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-xl bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-500 hover:to-pink-500 text-white text-xs font-semibold font-mono shadow-md shadow-rose-950/40 transition-all flex items-center gap-1.5 active:scale-95"
        >
          <Music className="w-3.5 h-3.5" />
          <span>Sing Anthem</span>
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="bg-slate-950/80 border border-rose-900/30 rounded-xl p-3.5 flex flex-col justify-between hover:border-rose-700/50 transition-all">
          <div>
            <div className="flex items-center justify-between">
              ...
              <span className="text-[9px] font-mono text-slate-500 uppercase">High Chants</span>
            </div>
          ...
          >
            ...
            <span>Test Gemini Voice (E5)</span>
          </button>
        </div>
        ...
        <div className="bg-slate-950/80 border border-cyan-900/30 rounded-xl p-3.5 flex flex-col justify-between hover:border-cyan-700/50 transition-all">
          ...
          >
            <Volume2 className="w-3.5 h-3.5" />
            <span>Test DeepSeek Voice (D3)</span>
          </button>
        </div>
      </div>
    </div>
